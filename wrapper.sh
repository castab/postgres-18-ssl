...
# PostgreSQL 18+ uses a version-specific PGDATA path: /var/lib/postgresql/18/docker
# The recommended approach is to mount to the parent directory /var/lib/postgresql
EXPECTED_VOLUME_MOUNT_PATH="/var/lib/postgresql"
EXPECTED_PGDATA_PATH="/var/lib/postgresql/18/docker"
...
# Note: SSL directory should be relative to the volume mount, not the old /var/lib/postgresql/data path
